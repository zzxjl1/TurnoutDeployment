...
def plot_all(uuid):
    ...
    ae = renderProcessPool.apply_async(plot_ae, (uuid,))
    input_sample = renderProcessPool.apply_async(plot_sample, (uuid,))
    seg_pts = renderProcessPool.apply_async(plot_seg_pts, (uuid,))
